...
import com.sean.oppnet.business.data.cache.FORCE_UPDATE_NOTE_EXCEPTION
...
import com.sean.oppnet.business.interactor.notedetail.UpdateNote.Companion.UPDATE_NOTE_FAILED
import com.sean.oppnet.business.interactor.notedetail.UpdateNote.Companion.UPDATE_NOTE_SUCCESS
import com.sean.oppnet.di.DependencyContainer
import com.sean.oppnet.framework.presentation.notedetail.state.NoteDetailStateEvent
...
class UpdateNoteTest {
    ...
    fun updateNote_success_confirmNetworkAndCacheUpdated() = runBlocking {
        ...
        val randomNote = noteCacheDataSource.searchNote("", "", 1)
            .get(0)
